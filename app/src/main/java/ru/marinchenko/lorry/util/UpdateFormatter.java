...
public class UpdateFormatter {
    ...
    private static final String SEC_3 = " секунды";
    private static final String SEC_5 = " секунд";
    ...
    public static String format(int sec){
        ...
        else if(sec < 5) return UPDATE + sec + SEC_3;
        else if(sec < 60) return UPDATE + sec + SEC_5;
